...
#
#     PHX_SERVER=true bin/lalia_bema start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :lalia_bema, LaliaBemaWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :lalia_bema, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :lalia_bema, LaliaBema.Mailer,
